import pandas as pd
from model_DSCNN import DS_CNNet
...
conf_matrix, scores = model_evaluation_onehot(y_pred, y_test, classes_tuar) # shouldn't be onehot???
...
ax.xaxis.set_ticklabels(classes_tuar)
ax.yaxis.set_ticklabels(classes_tuar)

#plt.savefig(path+model_type+'_cat_conf_matrix.png')
#plt.show()